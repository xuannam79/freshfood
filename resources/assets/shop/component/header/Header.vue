                ...
                <div class="col-12">
                    <div class="header_wrapper_inner">
                        ...
                        <div class="logo col-xs-12">
                            <a href="index.html">
                                <img src="/assets/shop/library/img/logo/logo.png" alt="">
                            </a>
                        </div>
                                    ...
                                    <div class="mini_cart_box cart_box_one">
                                        <div class="mini_cart_item">
                                            <div class="mini_cart_img">
                                                <a href="#">
                                                    <img src="/assets/shop/library/img/cart/1.jpg" alt="">
                                        ...
                                        <div class="mini_cart_item">
                                            <div class="mini_cart_img">
                                                <a href="#">
                                                    <img src="/assets/shop/library/img/cart/2.jpg" alt="">
                                                    <span class="cart_count">1</span>
                                                </a>
                                            </div>
                                            <div class="cart_info">
                                ...
                                <div class="content-setting-dropdown">
                                    <div class="language-selector-wrapper">
                                        <div class="language-selector">
                                            <ul>
                                                <li><a href="#"><img src="/assets/shop/library/img/1.jpg" alt="English"><span class="expand-more">English</span></a></li>

                                                <li><a href="#"><img src="/assets/shop/library/img/banner/frances2.jpg" alt="Language"><span class="expand-more">Français</span> </a></li>
